void showHelpScreen()
    ...
    writeLine("STUDENT: Vinayak Gargya",L++); //** Put your name here
    writeLine("PARTNER: Amita Karunakaram",L++); //** Put your team partner's name here
    ...
    writeLine("DISPLAY f:fill, #:Point IDs, v:arrows, g:increase grid lines, h:decrease grid lines",L++);
